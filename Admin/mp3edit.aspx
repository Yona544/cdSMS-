                                    ...
                                    <table class="gridtable" id="Table2" cellspacing="1" cellpadding="4" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tblrow">
                                                ...
                                                <td valign="middle" align="left" class="tblrow">
                                                    <asp:TextBox ID="txtDescription" runat="server" Rows="8" Columns="60" TextMode="MultiLine"></asp:TextBox>
                                            ...
                                            <tr class="tblrow" runat="server" id="rowTags">
                                                ...
                                                <td valign="middle" align="left" class="tblrow">
                                                    <asp:TextBox ID="txtTags" runat="server" Rows="8" Columns="60" TextMode="MultiLine"></asp:TextBox>
