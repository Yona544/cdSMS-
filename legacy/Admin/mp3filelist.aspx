<%@ Page Language="VB" AutoEventWireup="false" CodeFile="mp3filelist.aspx.vb" Inherits="Admin_mp3filelist" %>
                                    ...
                                    <div class="content-table-inner">
                                        <div id="table-search">
                                            <table class="gridtable" id="Table2" cellspacing="1" cellpadding="4" width="70%"
                                                ...
                                                <tr class="tblheader">
                                                    <td valign="middle" align="left" colspan="2">Search
                                                    </td>
                                                </tr>
                                                <tr class="tblaltrow">
                                                    <td valign="middle" align="left" width="20%" class="tblrowheader">Name
                                                    </td>
                                            ...
                                            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                                                <tr>
                                                    <td class="page_title" align="right">
                                                        <asp:HyperLink ID="hlNewMp3" runat="server" NavigateUrl="mp3add.aspx"> <img src="images/icon_plus.gif" width="21" height="21" alt="" />&nbsp;Add New File</asp:HyperLink>
                                                        <br />
                                                        <br />
                                                    </td>
                                                </tr>
                                                        ...
                                                        <asp:DataGrid ID="dgDiscount" runat="server" CssClass="gridtable" GridLines="None"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Name" HeaderStyle-CssClass="tblheader" SortExpression="Name">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <audio controls>
  <source src="../files/mp3/<%# DataBinder.Eval(Container.DataItem, "fileName")%>" type="audio/mpeg">
  Your browser does not support the audio tag.
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Edit" HeaderStyle-CssClass="tblheader">
                                                                   ...
                                                                   <ItemStyle Width="9%" HorizontalAlign="Center" />
                                                                    <ItemTemplate>
                                                                        <a href="mp3edit.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>">Edit</a>
                                                                    </ItemTemplate>
                                                                </asp:TemplateColumn>
                                                ...
                                                <tr id="ButtonsTR" runat="server">
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Button ID="btnDelete" runat="server" CssClass="myButton" Text="Delete" CausesValidation="False"></asp:Button>
                                                                </td>
                                                                <td align="center"></td>
                                                                <td align="right"></td>
                                                            </tr>
